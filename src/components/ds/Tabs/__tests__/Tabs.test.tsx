...
describe('Tabs', () => {
  it('defaults to testID=ds-tabs and role=tablist', () => {
    const {getByTestId} = render(
      <Tabs items={items} selectedValue="a" onChange={() => {}} />,
    );
    expect(getByTestId('ds-tabs').props.accessibilityRole).toBe('tablist');
  });
  ...
  it('fires onChange with item value on press', () => {
    ...
    fireEvent.press(getByTestId('ds-tab-item-c'));
