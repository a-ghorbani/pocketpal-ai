...
describe('IconButton', () => {
  it('defaults to testID=ds-icon-button and role=button', () => {
    const {getByTestId} = render(
      <IconButton icon={<Icon />} accessibilityLabel="Star" />,
    );
    const el = getByTestId('ds-icon-button');
  ...
  it('forwards accessibilityLabel and renders icon', () => {
    ...
    expect(getByTestId('ds-icon-button').props.accessibilityLabel).toBe('Star');
  ...
  it('calls onPress', () => {
    ...
    fireEvent.press(getByTestId('ds-icon-button'));
