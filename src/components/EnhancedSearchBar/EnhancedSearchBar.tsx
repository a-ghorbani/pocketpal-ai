  ...
  const sourceOptions = useMemo(
    () =>
      MODEL_SOURCE_IDS.map(value => ({
        value,
        // Mark the third-party mirror explicitly so users make a conscious
        // trust choice before searching or sending a token through it.
        label:
          value === 'hf_mirror'
            ? `${l10n.models.search.sources[value]}${l10n.models.search.thirdPartySuffix}`
            : l10n.models.search.sources[value],
      })),
    [l10n],
  );
