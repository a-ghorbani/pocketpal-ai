...
export const MODEL_SOURCE_CONFIGS: Record<ModelSourceId, ModelSourceConfig> = {
  ...
  // NOTE: hf-mirror.com is a third-party HF mirror. It is kept as an
  // explicit, opt-in source (never the default) so users make a conscious
  // trust choice; official huggingface.co IDs stay unprefixed and unchanged.
  hf_mirror: {
    id: 'hf_mirror',
