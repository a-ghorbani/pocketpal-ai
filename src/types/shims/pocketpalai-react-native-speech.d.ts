/**
 * Minimal ambient module declaration for `@pocketpalai/react-native-speech`.
 *
...
declare module '@pocketpalai/react-native-speech' {
  ...
  /**
   * Engine identifier enum — mirrors `@pocketpalai/react-native-speech/src/types/Engine.ts`.
